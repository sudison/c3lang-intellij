...
public class C3StructDeclarationListImpl extends ASTWrapperPsiElement implements C3StructDeclarationList {

  public C3StructDeclarationListImpl(@NotNull ASTNode node) {
    super(node);
  }
