...
public interface C3Types {
  ...
  IElementType IF_STATEMENT = new C3ElementType("IF_STATEMENT");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ADDITIVE_EXPRESSION) {
        ...
        return new C3IfStatementImpl(node);
      }
      ...
      else if (type == STRUCT_MEMBER_DECLARATION_TYPE) {
        return new C3StructMemberDeclarationTypeImpl(node);
      }
